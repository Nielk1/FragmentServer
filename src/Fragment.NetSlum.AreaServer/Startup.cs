...
//using Fragment.NetSlum.AreaServer.Converters;
using Fragment.NetSlum.AreaServer.Servers;
//using Fragment.NetSlum.AreaServer.Services;
...
namespace Fragment.NetSlum.AreaServer;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddPacketHandling(ServerType.Area);
